...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Semua Kategori' or . = 'Semua Kategori') and @resource-id = 'com.she.sehatq:id/tvCategoryName']</locator>
