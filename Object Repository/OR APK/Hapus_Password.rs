...
<MobileElementEntity>
   ...
   <name>Hapus_Password</name>
   <tag></tag>
   <elementGuidId>3bfb7f1b-81c0-45d4-ae96-f32f38a28150</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.EditText' and @index = '0' and @resource-id = 'com.she.sehatq:id/et_input' and @clickable = 'true' and @password = 'true']</locator>
